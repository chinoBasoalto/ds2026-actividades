...
const divLista = document.getElementById("lista-libros") as HTMLDivElement;
const divStats = document.getElementById("stats") as HTMLDivElement;
const errorDiv = document.getElementById("errorForm") as HTMLDivElement;

// Inputs del Formulario
const txtTitulo = document.getElementById("titulo") as HTMLInputElement;
const txtAutor = document.getElementById("autor") as HTMLInputElement;
const numPrecio = document.getElementById("precio") as HTMLInputElement;
const txtGenero = document.getElementById("genero") as HTMLInputElement;
const chkDisponible = document.getElementById("disponible") as HTMLInputElement;
...
document.getElementById("btnFiltrar")?.addEventListener("click", () => {
    const busqueda = (document.getElementById("inputAutor") as HTMLInputElement).value.toLowerCase();
